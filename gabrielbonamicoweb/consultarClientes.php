...
<body> 
	<div class="container">
		...
		<div class="row" style="background-color: #d22e2e;">
				...
				<div class="card-body" style="margin: auto;">
					...
					<table class="table table-responsive" style="width: auto;">
						<thead class="table-active bg-primary">
							<tr style="background-color: #d22e2e;">
								<th scope="col">ID</th>
						...
						?>
								<tr>
									...
									<td scope="col"><?php echo $resultado[$i]['idade']; ?></td>
									<td scope="col"><?php echo $resultado[$i]['data_contato']; ?></td>
									<td scope="col"><?php echo $resultado[$i]['motivo']; ?></td>
									<td scope="col">
